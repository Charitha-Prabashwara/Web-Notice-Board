...
$newsObj = new GetNews();
$noticeObj = new GetNotice();

$latest5_news_array= $newsObj->Get_latest5_News();
$latest5_notice_array=$noticeObj->Get_latest5_Notice();
...
<main class="container">
  ...
  <div class="my-3 p-3 bg-body rounded shadow-sm">
    <h6 class="border-bottom pb-2 mb-0">News <small>( Top 5)</small></h6>
    <?php
      for ($i=0; $i < sizeof($latest5_news_array); $i++) { 
        //print_r($latest5_news_array[$i]['id']);
        $urlGen = "news.php?id=" . $latest5_news_array[$i]['id'];
          ...
          echo "<a href='" . $urlGen . "' class='h6 d-block text-gray-dark link-offset-2 text-decoration-none text-dark'>" .$latest5_news_array[$i]['title'] . "</a>";
          echo $latest5_news_array[$i]['subtitle'] . "</p>";
          echo "</div>";
  ...
  <div class="my-3 p-3 bg-body rounded shadow-sm">
    <h6 class="border-bottom pb-2 mb-0">Notice <small>( Top 5)</small></h6>
      ...
      for ($i=0; $i < sizeof($latest5_notice_array); $i++) { 
        //print_r($latest5_news_array[$i]['id']);
        $urlGen = "notice.php?id=" . $latest5_notice_array[$i]['id'];
        echo "
        ...
        <strong class='text-gray-dark'><a href='" .  $urlGen . "' class='h6 d-block text-gray-dark link-offset-2 text-decoration-none text-dark'>" . $latest5_notice_array[$i]['title'] ."</a></strong>
          
        </div>
        <span class='d-block'>" . $latest5_notice_array[$i]['subtitle'] ."</span>
        </div>
      </div>
